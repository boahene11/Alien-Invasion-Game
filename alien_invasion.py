...
class AlienInvasion:
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Get rid of remaining bullets snd aliens.
            self.bullets.empty()
            self.aliens.empty()
    ...
    def _check_fleet_edges(self):
        """Respond appropriate if any alien have reached the edge of the edge."""
        for alien in self.aliens.sprites():
...
if __name__ == "__main__":
    ...
    ai = AlienInvasion(screen=pygame.display.get_surface())
    ai.run_game()